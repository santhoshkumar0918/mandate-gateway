...
Push the three reconciliation commits (`70f8b4d`, `41aba55`, `4b12085`)
to `main`. After that, the natural next step is an end-to-end run of the
drift scenario against the running gateway + dashboard, or a hardening
pass on the two limitations above.
